...
headers = ['Name','Team','Nac.','Age','Height','Preffoot','Position','Number','ValuePlayer','matchesTotal', 'matchesStarting',
           ...
           'bigChanceCreated', 'keyPasses','accuratePassesPerGame','successfulPassesOwnHalf','successfulPassesOppositionHalf','successfulLongPasses',
           'accurateChippedPasses','successfulCrossesAndCorners','interceptionsPerGame','tacklesPerGame','possessionWonFinalThird',
           'challengesLostPerGame','totalClearancesPerGame','errorLeadToAShot','errorLeadToaGoal','penaltiesConceded',
